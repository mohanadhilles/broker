     ...
     :src="user.imgUrl">
                                ...
                                <div class="media-body media-info">
                                    ...
                                    <h3 class="profile-about"
                                        v-if=" auth.bio  == null || auth.passport  == null || auth.nationality.title  == null || auth.whats_app == null">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="form-group row"
                                                                    ...
                                                                    <label
                                                                        class=" col-form-label">{{$t("gender")}}</label>
                                                                    <div class="input-field">
                                                                        <div class="row">
                                                                ...
                                                                <div class="form-group form-select row">
                                                                    <label class="col-form-label" for="Educations">{{$t("profile.contract")}}</label>
                                                                    <div class="input-field">
                                                                        <select class="form-control" id="english_lang"
                                                                            ...
                                                                            <option
                                                                                ...
                                                                                :value="contract.id">{{contract.title }}
                                                                            </option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group row"
                                                                     :class="['form-group', allerros.salary ? 'has-danger' : '']">
                                                                    <label class="col-form-label">{{$t("profile.expected")}}</label>
                                                                    <div class="input-field">
                                                                        <input class="form-control"
                                                                               v-model="user.salary"
                                                                               :class="['form-control', allerros.salary ? 'has-danger' : '']"
                                                                               name="salary" required type="text">
                                                                        <span v-if="allerros.salary"
                                                                              :class="['badge badge-danger']">@{{ allerros.salary[0] }}</span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group form-select row">
                                                                ...
                                                                <div class="form-group row"
                                                                     :class="['form-group', allerros.youtube ? 'has-danger' : '']">
                                                                    <label
                                                                        class="col-form-label">{{$t("profile.yt")}}</label>
                                                                    <div class="input-field">
                                                                        <input class="form-control"
                                                                               v-model="user.youtube"
                                                                               :class="['form-control', allerros.youtube ? 'has-danger' : '']"
                                                                               name="youtube" required type="text">
                                                                        <span v-if="allerros.youtube"
                                                                              :class="['badge badge-danger']">@{{ allerros.youtube[0] }}</span>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="form-group form-select row"
                                                                    ...
                                                                    <div class="input-field">
                                                                        ...
                                                                        <span v-if="allerros.education"
                                                                              :class="['badge badge-danger']">@{{ allerros.education[0] }}</span>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group row"
                                                                    ...
                                                                    <label class="col-form-label">{{$t("profile.child")}}</label>
                                                                    <div class="input-field">
                                                                        <input class="form-control"
                                                                ...
                                                                <div class="form-group row">
                                                                    <label class="col-form-label">{{$t("profile.exp_passport")}}</label>
                                                                    <div class="input-field">
                                                                        <input class="form-control"
                                                                               v-model="user.passport_date_of_exp"
                                                                               name="passport_date_of_exp" required
                                                                               type="date">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label class="col-form-label">{{$t("profile.issue_passport")}}</label>
                                                                    <div class="input-field">
                                                                        <input class="form-control"
                                                                               v-model="user.passport_date_of_issue"
                                                                               name="passport_date_of_issue" required
                                                                               type="date">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label class="col-form-label">{{$t("profile.valid_visa")}}</label>
                                                                    <div class="input-field">
                                                                        <input class="form-control"
                                                                               v-model="user.exp_visa"
                                                                               name="exp_visa" required
                                                                               type="date">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label class=" col-form-label">{{$t("profile.available")}}</label>
                                                                    <div class="input-field">
                                                                        <input class="form-control"
                                                                               v-model="user.available_at"
                                                                               name="available_at" required
                                                                               type="date">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row"
                                                                ...
                                                                <div class="form-group form-select row">
                                                                    <label class=" col-form-label" for="country">{{$t("profile.place_birth")}}</label>
                                                                    <div class="input-field">
                                                                        <select class="form-control" id="place_of_birth"
                                                    ...
                                                    <form action="" class="resume-form" method="post">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="form-group form-select row">
                                                                    <label class="col-form-label" for="Educations">{{$t("profile.edu")}}</label>
                                                                    <div class="input-field">
                                                                        <select class="form-control" id="Educations"
                                                                                v-model="user.education"
                                                                                name="education">
