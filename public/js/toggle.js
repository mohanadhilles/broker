$(document).ready(function () {
    ...
    $("ul.list li.list-item").click(function () {
        ...
        $(this).children('img').attr("src","../assets/img/listUpArrow.png");
        ...
        if ($('section.resume').is(":hidden")){
            $(".img1").attr("src","../assets/img/listArrow.png");
            $('.changePhoto').hide();

        } else if($('section.resume').is(":visible")){
            $(".img1").attr("src","../assets/img/listUpArrow.png");
            $('.changePhoto').show();

        }

        if ($('section.referral').is(":hidden")){
            $(".img2").attr("src","../assets/img/listArrow.png");
        } else if($('section.referral').is(":visible")){
            $(".img2").attr("src","../assets/img/listUpArrow.png");
        }

        if ($('section.job-applied').is(":hidden")){
            $(".img3").attr("src","../assets/img/listArrow.png");
        } else if($('section.job-applied').is(":visible")){
            $(".img3").attr("src","../assets/img/listUpArrow.png");
        }
